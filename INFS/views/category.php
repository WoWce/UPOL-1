                ...
                <ul class="post-list">
                    <li>
                        <article class="post-preview-detailed">
                            <img src="../article-img/test.jpg" alt="title" />
        ...
        <aside>
                ...
                <ul class="social-blocks">
                    ...
                    <li>
                        <a href="instagram.com">
                            <div class="rect-inst">
                                <img src="../img/category/instagram-logo-white.png" alt="Instagram">
                            </div>
                        </a>
                        <h3>
                            9,874
            ...
            <section class="category inst">
                ...
                <div class="inst-container">
                    <ul>
                        <li>
                            <img src="../article-img/test.jpg" alt="instagram-foto">
                        </li>
                        <li>
                            <img src="../article-img/test.jpg" alt="instagram-foto">
                        </li>
